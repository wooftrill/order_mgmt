...
class SQLUtils:
    ...
    @staticmethod
    def update(table_name: str,order_id: str,checkout_ldts,ldts, grand_total,uid:str, session_id: str):
        return f"Update external.{table_name} SET order_id='{order_id}', checkout_ldts={checkout_ldts},ldts={ldts}, grand_total={grand_total} where uid='{uid}'and session_id='{session_id}' and payment_status=0;"
